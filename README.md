<h1 align="center">CiviCDR Client App</h1>

## Installation and Usage

The steps below will walk you through setting up your own instance of the CiviCDR Client App
...
Staging deployments are pushed to S3 via CircleCI
